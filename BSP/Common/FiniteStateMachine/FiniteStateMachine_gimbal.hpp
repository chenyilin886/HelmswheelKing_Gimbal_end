...
public:
     ...
     * @brief 获取当前状态
     */
    inline Enum_Gimbal_States Get_Now_State() const;

    /**
     * @brief 获取当前状态名称
     */
    inline const char* Get_Now_State_Name() const;
 ...
 * @brief 获取当前状态
 */
inline Enum_Gimbal_States Gimbal_FSM::Get_Now_State() const
{
    return State_gimbal;
}
 ...
 * @brief 获取当前状态名称
 */
inline const char* Gimbal_FSM::Get_Now_State_Name() const
{
