...
void CanBus::init()
{
    if (devices_[(size_t)CanDeviceId::HAL_Can1] != nullptr)
    {
        devices_[(size_t)CanDeviceId::HAL_Can1]->init();
        devices_[(size_t)CanDeviceId::HAL_Can1]->start();
    }

    if (devices_[(size_t)CanDeviceId::HAL_Can2] != nullptr)
    {
        devices_[(size_t)CanDeviceId::HAL_Can2]->init();
        devices_[(size_t)CanDeviceId::HAL_Can2]->start();
    }
}
